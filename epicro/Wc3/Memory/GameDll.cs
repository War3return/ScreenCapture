...
namespace epicro.Wc3.Memory
{
    public static class GameDll
    {
        public static bool HPView
        {
            get
            {
                if (GameDllOffset != IntPtr.Zero)
                {
                    ...
                    if (buffer != null && CompareArrays(buffer, pattern, 1)) return true;
                }
                return false;
            }
            set
        ...
        public static float StartDelay
        {
            ...
            {
                if (GameDllOffset != IntPtr.Zero)
                    try { return BitConverter.ToSingle(Bring(GameDllOffset + 0x324146, 4), 0); }
                    catch { }
                return -1;
            }
            set
        ...
        public static float RefreshCooldown
        {
            ...
            {
                if (GameDllOffset != IntPtr.Zero)
                    try { return BitConverter.ToSingle(Bring(GameDllOffset + 0x310C07, 4), 0); }
                    catch { }
                return -1;
            }
            set
        ...
        public static bool ColorfulChat
        {
            ...
            {
                if (GameDllOffset == IntPtr.Zero) return;
                Patch(GameDllOffset + 0x1518C0, value
                    ? new byte[] { 0xE9, 0x9B, 0x00, 0x00, 0x00, 0x90, 0x90, 0x90, 0x90 }
                    : new byte[] { 0x83, 0xF8, 0x03, 0x0F, 0x87, 0x97, 0x00, 0x00, 0x00 });
                Patch(GameDllOffset + 0x1D00E0, value
                    ? new byte[] { 0x44, 0x24, 0x18, 0x5E, 0x5B, 0x5D, 0xC2, 0x18, 0x00 }
        ...
        public static float CameraDistance
        {
            ...
            {
                if (GameDllOffset != IntPtr.Zero)
                    try { return BitConverter.ToSingle(Bring(GameDllOffset + 0xA8F300, 4), 0); }
                    catch { }
                return -1;
            }
            set
        ...
        public static float CameraAngleX
        {
            ...
            {
                if (GameDllOffset != IntPtr.Zero)
                    try { return BitConverter.ToSingle(Bring(GameDllOffset + 0xA8F2D0, 4), 0); }
                    catch { }
                return -1;
            }
            set
        ...
        public static float CameraAngleY
        {
            ...
            {
                if (GameDllOffset != IntPtr.Zero)
                    try { return BitConverter.ToSingle(Bring(GameDllOffset + 0xA8F2F0, 4), 0); }
                    catch { }
                return -1;
            }
            set
